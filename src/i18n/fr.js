export const fr = {
  ...
  dashboard: {
    ...
    seeAll: 'Voir tout',
    of: 'sur',
    customersOverview: 'Vue clients',
    refrigeratorsStatus: 'État des réfrigérateurs',
    noCustomers: 'Aucun client',
    noRefrigerators: 'Aucun réfrigérateur',
    date: 'Date',
    tableCustomer: 'Client',
    tableSupervisor: 'Superviseur',
    tableCondition: 'État',
    tableCleanliness: 'Propreté',
    tableIssueType: 'Type',
  ...
  warnings: {
    ...
    count: '{count} avertissements actifs',
    countSingular: '1 avertissement actif',
    issue: 'Avertir le client',
    reason: 'Raison',
    reasonPlaceholder: 'Décrivez la raison de l\'avertissement...',
    issuedBy: 'Émis par',
    issuedAt: 'Émis le',
    dismiss: 'Annuler',
    dismissed: 'Annulé',
    dismissedBy: 'Annulé par',
    dismissedAt: 'Annulé le',
    saved: 'Avertissement enregistré.',
    dismissedMsg: 'Avertissement annulé.',
    deleteFailed: 'Échec de l\'annulation.',
    banner: 'Ce client a {count} avertissements actifs. Veuillez revoir le contrat.',
  ...
  users: {
    ...
    deleteConfirm: 'Cet utilisateur sera définitivement supprimé. Cette action est irréversible.',
    deleteFailed: 'Échec de la suppression de l\'utilisateur.',
    resetPassword: 'Réinitialiser le mot de passe',
    resetPasswordConfirm: 'Entrez un nouveau mot de passe pour cet utilisateur.',
